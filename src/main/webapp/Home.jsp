      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="DEsign/img/user.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Your name:</strong> <span><%= LoginDAO.currentUserName %></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Your email:</strong> <span><%= LoginDAO.currentUserEmail %></span></li>
                </ul>
              </div>
            </div>
